				...
				<div class="col-md-12">
					<div class="table-container">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<label class="label-input">Survey : </label>
...
<script type="text/javascript">
      $(document).ready(function() {
		...
		$.ajax({
            cache: false,
            type: 'GET',
            url: '/petugas/report/create_pdf_survey_unit',
            contentType: false,
            processData: false,
            data: 'q=create_pdf&tglmulai=' + ed_mulai + '&tglsampai=' + ed_sampai+ '&petugas=' + petugas+ '&pelayanan=' + pelayanan,
