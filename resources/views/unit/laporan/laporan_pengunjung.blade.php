    ...
    <div class="modal-content" style="color:black;">
      ...
      <div class="modal-body" >
		...
		<div class="modal-footer">
			<button class="btn btn-success bt_export_pdf" data-id="0"  style="align-items:left;">Download <span class="fa fa-file-pdf-o"></span></button>
...
<script type="text/javascript">
	...
	if(e.which===1){
		...
		$.ajax({
            cache: false,
            type: 'GET',
            url: '/petugas/report/create_pdf_pengunjung_unit',
            contentType: false,
            processData: false,
            data: 'q=create_pdf&tglmulai=' + tglmulai + '&tglsampai=' + tglsampai+ '&id_user=' + id_user+ '&petugas=' + petugas,
