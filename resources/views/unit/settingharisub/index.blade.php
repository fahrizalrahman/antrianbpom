      ...
      <div class="container-fluid">
           ...
           <div class="card">
            <div class="card-header">
                <a href="{{ route('unit-settingharisub.create') }}" class="btn btn-primary" type="button" ><i class="nav-icon fa fa-plus"></i> Tambah</a>
                 ...
                 <tr>
                  ...
                  <td>
                    <a href="{{ route('unit-settingharisub.edit', $value->id) }}" class="btn btn-warning btn-sm"><i class="nav-icon fa fa-wrench"></i></a> || 
                     ...
                     <a href="{{ route('unit-settingharisub.delete',$value->id)}}" class="btn btn-danger btn-sm"><i class="nav-icon fa fa-trash"></i></a>
