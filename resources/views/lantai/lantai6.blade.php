...
<body class="container-fluid" style="background-image:url({{url(Storage::url(@$Background->first()->filename))}});">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="width:120.%; height:auto;">
                <table border="1px;" style="width:132.8%; margin-left:-5px; border-color:gray;">
                    ...
                    <tr>
                        <td class="col-sm-5" style="background-color:#2b869d; height:55px; width:400px;color:white;">{{$lantai6->nama_layanan}}</td>
                        <td id="td_style" rowspan="2" style="background-color:#236c7d; width:100px; height:55px; text-align:center; border-color:honeydew;color:white;"><h3 style="float:left; margin-left:25px;">{{$lantai6->kode_antrian}} - </h3><h3 style="float:left; margin-left:8px;" id="lok_{{ $_i }}"></h3></td>
                    </tr>
                    <tr>
                        <td class="col-sm-5" style="background-color:#34a1bc; height:55px; width:400px;color:white;">{{$lantai6->kode}}</td>
                    </tr>
                    <?php $_i++; ?>
                    @endforeach
                </table>
        ...
        <div class="row">
                ...
                @if($imgFotL6->count() > 0)
                <div class="col-md-6" style="background-image:url({{url(Storage::url($imgFotL6->first()->filename))}}); width:auto; height:75px;">
                </div>
                @else
                ...
                @endif
                @if($imgFotR6->count() > 0)
                <div class="col-md-6" style="background-image:url({{url(Storage::url($imgFotR6->first()->filename))}}); width:auto; height:75px;">
                 </div>
                 @else
                 <div class="col-md-6" style="background-color:white; width:auto; height:75px;">
                </div>
