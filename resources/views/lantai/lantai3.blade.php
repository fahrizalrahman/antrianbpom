  ...
  <div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="col-sm-12" style="height:70px; background-color:#e6e6e6;">
                ...
                <div class="col-md-12" style="height:4px; width:100%; background-color:#3badc9;">
                </div>
      ...
      <div class="col-sm-4" style="background-color:darkgray;  height:auto;">
        ...
        @if($bgLantai3->first()->type == 'Video')
            <div class="col-sm-7"  style="width:820px; height:auto; background-size:cover; background-position:center; background-repeat:no-repeat;">                 
                <video style=" margin-left:125px; min-width:480px; min-height:510px; position:center;" controls autoplay loop>
                ...
                @else
                    <div style="background-color:#34a1bc; margin-left:125px; margin-top:-5px; width:906px; height:229px;">
                    </div>
                @endif
    ...
    <div class="col-md-12" style="width:103%;">
        <table border="0px" style="width:104%; height:40px; margin-left:-29px;">
            <tr>
                ...
                @else
                    <td style="width:1500px; background-color:#e6e6e6; color:#252525; size:19px;"><marquee> <b>SELAMAT DATANG</b></marquee></td>
                @endif
