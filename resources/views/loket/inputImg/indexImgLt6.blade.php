          ...
          @include('layouts._flash')
           <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('loket.inputImg.indexImgLt6')}}" id="admin_filter" class="btn btn-danger">Lantai 6</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="admin" class="table table-bordered table-striped">
                ...
                @foreach($Lt6 as $value)
                 <tr>
                  ...
                  <td align="center">
                      <form action="{{route('inputImgLt6.destroy6', $value->id)}}" method="POST">
