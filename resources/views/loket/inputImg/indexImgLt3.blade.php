          ...
          @include('layouts._flash')
           <div class="card">
            <div class="card-header">
                ...
                <a href="{{route('loket.inputImg.indexImgLt3')}}" id="admin_filter" class="btn btn-danger">Lantai 3</a>
              ...
              <table id="admin" class="table table-bordered table-striped">
                ...
                @foreach($Lt3 as $value)
                 <tr>
                  ...
                  <td align="center">
                      <form action="{{route('inputImgLt3.destroy3', $value->id)}}" method="POST">
