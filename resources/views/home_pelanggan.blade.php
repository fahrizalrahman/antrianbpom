                            ...
                            <div class="card-body" style="height:200px;background: #ff9900">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal1" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-1" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card" >
                            <div class="card-body" style="height:200px;background: #ff3300">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal2" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-2" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card" >
                            <div class="card-body" style="height:200px;background: #85adad">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                <div class="row"> 
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal3" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-3" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card" >
                            <div class="card-body" style="height:200px;background: #1a53ff">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal4" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-4" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card" >
                            <div class="card-body" style="height:200px;background: #33ff33">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal5" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-5" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="card" >
                            <div class="card-body" style="height:200px;background: #c44dff">
                             ...
                             <div class="card-footer" style="background-color:grey;">
                                <div class="row">
                                <div class="col-sm-6 col-xs-6">
                                  <center><button  data-toggle="modal" data-target="#myModal6" class="card-link btn btn-primary" type="button"><i class="fa fa-info"></i> Info </button>
                                  </div> </center>

                                  <div class="col-sm-6 col-xs-6">
                                  <center><button  class="card-link btn btn-primary" id="flip-6" type="button"><i class="fa fa-briefcase"></i> Pilih</button></center> 
                                </div>
                                </div>
                            </div>
                          </div>
