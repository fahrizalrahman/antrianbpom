...
// Controller Lantai
    public function lantai()
    {
        ...
        $bgLantai1 = GambarUtama::where('lantai','1')->orderby('id','desc');
    ...
    public function lantai2()
    {
        ...
        $bgLantai2 = GambarUtama::where('lantai','2')->orderby('id','desc');
    ...
    public function lantai3()
    {
        ...
        $bgLantai3 = GambarUtama::where('lantai','3')->orderby('id','desc');
    ...
    public function lantai4()
    {
        ...
        $bgLantai4 = GambarUtama::where('lantai','4')->orderby('id','desc');
    ...
    public function lantai5()
    {
        ...
        $bgLantai5 = GambarUtama::where('lantai','5')->orderby('id','desc');
    ...
    public function lantai6()
    {
        ...
        $bgLantai6 = GambarUtama::where('lantai','6')->orderby('id','desc');
